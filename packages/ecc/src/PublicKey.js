...
import {getAddressPrefix} from './AddressPrefix';
...
class PublicKey {
    ...
    toString(address_prefix = getAddressPrefix()) {
    ...
    /**
        ...
        {return} string
    */
    toPublicKeyString(address_prefix = getAddressPrefix()) {
        var pub_buf = this.toBuffer();
    ...
    */
    static fromPublicKeyString(public_key, address_prefix = getAddressPrefix()) {
        try {
    ...
    /**
        ...
        @return PublicKey
    */
    static fromStringOrThrow(public_key, address_prefix = getAddressPrefix()) {
    ...
    toAddressString(address_prefix = getAddressPrefix()) {
        var pub_buf = this.toBuffer();
        var pub_sha = sha512(pub_buf);
