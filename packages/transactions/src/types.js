...
import { PublicKey, Address, getAddressPrefix } from "karmachain-ecc";
...
Types.public_key = {
    ...
    toObject(object, debug = {}){
        if (debug.use_default && object === undefined) {
            return getAddressPrefix() + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
        }
        v.required(object);
        return object.toString()
    },
...
Types.address =
    ...
    toObject(object, debug = {}){
        if (debug.use_default && object === undefined) {
            return getAddressPrefix() + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
        }
